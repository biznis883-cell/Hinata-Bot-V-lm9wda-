module.exports = {
        ...
        onStart: async function ({ api, message, event }) {
                ...
                const githubLink = "hello MEMBRES i bot issmail meddah py prefex is #";
                const youtubeLink = "is my link admin bot (bassit 💋) https://www.facebook.com/profile.php?id=61594329770983";
